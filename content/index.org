...
#+name: tsdec1
[[#slowfast][file:images/research/tdecomp.png]]
...
_Links_
+ Research to be conducted in collaboration with [[https://www.me.gatech.edu/faculty/leamy][Prof. Mike Leamy at
  Georgia Tech]]. 
+ [[wbmmod1][(Image) The wave-based description for a jointed bar]] and [[wbmmod2][(Image)
  modified AFT procedure for this]].
+ [[#wbmpaper][Entry on past work on this area]].
...
The following is a (non-exhaustive) list of specific projects I plan
to actively seek funding for in the short-term:
#+begin_picblurb-container
#+attr_html: :id slowfast
#+begin_picblurb
#+begin_vpic
...
#+begin_picblurb
  ...
  #+begin_blurb
  *Sathyanarayana Reddy* (M.Tech. 2024)
...
#+begin_picblurb
  ...
  #+begin_blurb
  *Dhanush M* (M.Tech. 2024)

  Development of Julia code for nonlinear vibration analysis.
